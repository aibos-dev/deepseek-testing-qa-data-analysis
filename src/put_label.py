...
model_name = "/workspace/models/DeepSeek-R1-Distill-Qwen-7B-Q2_K-00001-of-00001.gguf"
tokenizer = AutoTokenizer.from_pretrained("/workspace/models")

model = Llama(
    model_path=model_name,
    n_ctx=6144,  # Context length
    chat_format="chatml"
)
...
for index, chunk in enumerate(json_chunks):
    ...
    # Use model's chat completion method
    try:
